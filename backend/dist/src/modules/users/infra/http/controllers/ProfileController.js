...
var ProfileController = /** @class */ (function () {
    ...
    ProfileController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var user_id, showProfileService, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        user_id = request.user.id;
                        showProfileService = tsyringe_1.container.resolve(ShowProfileService_1.default);
                        return [4 /*yield*/, showProfileService.execute({ user_id: user_id })];
                    case 1:
                        user = _a.sent();
    ...
    ProfileController.prototype.update = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var user_id, _a, name, email, old_password, password, updateUser, user;
