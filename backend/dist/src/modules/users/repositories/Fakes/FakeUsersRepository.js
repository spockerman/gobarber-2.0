...
var FakeUsersRepository = /** @class */ (function () {
    ...
    FakeUsersRepository.prototype.findAllProviders = function (_a) {
        var expect_user_id = _a.expect_user_id;
        return __awaiter(this, void 0, void 0, function () {
            var users;
            return __generator(this, function (_b) {
                users = this.users;
                if (expect_user_id) {
                    users = this.users.filter(function (user) { return user.id !== expect_user_id; });
                }
    ...
    FakeUsersRepository.prototype.save = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var userIndex;
            return __generator(this, function (_a) {
                userIndex = this.users.findIndex(function (findIndex) { return findIndex.id === user.id; });
