...
var resetPassword;
describe("ResetPassowordService", function () {
    beforeEach(function () {
    ...
    it("should not be able to reset the password after two hours", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, token;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
