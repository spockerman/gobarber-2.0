...
describe("AuthenticateUser", function () {
    ...
    it("should be not able to authenticate with a non existing user", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it("should be not able to authenticate with wrong password", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fakeUsersRepository.create({
                        name: "John Doe",
