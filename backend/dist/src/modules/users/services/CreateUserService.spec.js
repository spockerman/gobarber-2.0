...
var fakeHashUserProvider;
var fakeCacheProvider;
var createUser;
describe("CreateUser", function () {
    beforeEach(function () {
        fakeUsersRepository = new FakeUsersRepository_1.default();
        fakeHashUserProvider = new FakeHashProvider_1.default();
        fakeCacheProvider = new FakeCacheProvider_1.default();
        createUser = new CreateUserService_1.default(fakeUsersRepository, fakeHashUserProvider, fakeCacheProvider);
    });
    ...
    it("should not be able to create two users with the same email", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createUser.execute({
                        name: "John Doe",
