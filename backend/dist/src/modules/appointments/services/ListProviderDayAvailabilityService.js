...
var ListProvidersDayAvailabilityService = /** @class */ (function () {
    function ListProvidersDayAvailabilityService(appointmentsRepository) {
        this.appointmentsRepository = appointmentsRepository;
    }
    ListProvidersDayAvailabilityService.prototype.execute = function (_a) {
    ...
    ListProvidersDayAvailabilityService = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject("AppointmentsRepository")),
        __metadata("design:paramtypes", [Object])
    ], ListProvidersDayAvailabilityService);
    return ListProvidersDayAvailabilityService;
}());
exports.default = ListProvidersDayAvailabilityService;
