...
var ListProvidersAppointmentsService = /** @class */ (function () {
    function ListProvidersAppointmentsService(appointmentsRepository, cacheProvider) {
        this.appointmentsRepository = appointmentsRepository;
        this.cacheProvider = cacheProvider;
    }
    ListProvidersAppointmentsService.prototype.execute = function (_a) {
    ...
    ListProvidersAppointmentsService = __decorate([
    ...
    return ListProvidersAppointmentsService;
}());
exports.default = ListProvidersAppointmentsService;
