...
var ListProvidersMonthAvailabilityService = /** @class */ (function () {
    function ListProvidersMonthAvailabilityService(appointmentsRepository) {
        this.appointmentsRepository = appointmentsRepository;
    }
    ListProvidersMonthAvailabilityService.prototype.execute = function (_a) {
    ...
    ListProvidersMonthAvailabilityService = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject("AppointmentsRepository")),
        __metadata("design:paramtypes", [Object])
    ], ListProvidersMonthAvailabilityService);
    return ListProvidersMonthAvailabilityService;
}());
exports.default = ListProvidersMonthAvailabilityService;
