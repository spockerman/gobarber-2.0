    ...
    DiskStorageProvider.prototype.saveFile = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fs_1.default.promises.mkdir(upload_1.default.uploadsFolder, {
                            recursive: true,
                        })];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, fs_1.default.promises.rename(path_1.default.resolve(upload_1.default.tmpFolder, file), path_1.default.resolve(upload_1.default.uploadsFolder, file))];
                    case 2:
                        _a.sent();
